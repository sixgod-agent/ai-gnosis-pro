      ...
      >
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-1 px-1.5 py-0.5 rounded bg-neon-green/10 border border-neon-green/20">
            ...
            <span className="text-[9px] sm:text-[10px] font-bold text-neon-green number-mono">
              首选生肖
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 sm:gap-4 mb-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-1 mt-1">
              ...
              <span className="text-[9px] sm:text-[10px] text-neon-green">连续命中 17 期</span>
            </div>
          </div>
        </div>

        <div className="mb-4">
          <div className="text-[9px] sm:text-[10px] text-text-secondary uppercase tracking-wider mb-2">
          ...
          <div className="flex gap-1.5 sm:gap-2 flex-wrap">
            {primaryNumbers.map((num, i) => (
              <motion.div
                ...
                className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-gradient-to-br from-neon-green to-emerald-600 flex items-center justify-center shadow-lg shadow-neon-green/20"
              >
                <span className="text-sm sm:text-base font-bold text-bg-primary number-mono">
        ...
        <div>
          <div className="flex justify-between items-center mb-1">
            <span className="text-[9px] sm:text-[10px] text-text-secondary uppercase tracking-wider">
              置信度 | CONFIDENCE
            </span>
            <span className="text-xs sm:text-sm font-bold text-neon-green number-mono">
              {animatedConf}%
            </span>
          </div>
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-1.5">
            ...
            <h2 className="text-[11px] sm:text-sm font-bold text-gold tracking-wide uppercase">
          ...
          <div className="flex items-center gap-1 px-1.5 py-0.5 rounded bg-gold/10 border border-gold/20">
            ...
            <span className="text-[9px] sm:text-[10px] font-bold text-gold number-mono">
              高频波动捕捉
            </span>
          </div>
        </div>
          ...
          {HEDGING_NUMBERS.map((num, i) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-lg bg-gradient-to-br from-bg-tertiary to-bg-secondary border border-gold/20 p-2 sm:p-3 flex flex-col items-center gap-0.5 sm:gap-1 hover:border-gold/40 transition-colors"
              >
                <span className="text-lg sm:text-xl font-bold text-gold number-mono">
                  {String(num).padStart(2, '0')}
                </span>
